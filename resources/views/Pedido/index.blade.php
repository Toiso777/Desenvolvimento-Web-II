...
<head>
    ...
    <title>{{__('translate.indexOrder')}}</title>
</head>
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <h3 class="my-2 text-center"><strong>{{__('translate.addProducts')}}</strong></h3>
    ...
    <div class="modal fade" id="id-destroy-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">{{__('translate.removeProductOrdered')}}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
            <div class="modal-body">
            {{__('translate.wishRemoveProduct')}}
            </div>
