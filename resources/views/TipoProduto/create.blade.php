...
<head>
    ...
    <title>{{__('translate.createFromTypeProduct')}}</title>
</head>
<body>
    <div class="container">
        <form method="POST" action="{{route('tipoproduto.store')}}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="descricao" class="form-control" id="input-desc" placeholder="{{__('translate.typeDescription')}}">
            </div>
